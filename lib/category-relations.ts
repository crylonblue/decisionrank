 ...
 * - wearable:        smart-watches, fitness-trackers, sleep-trackers, smart-rings, wireless-earbuds, open-ear-headphones, over-ear-headphones, bluetooth-speakers
...
const BASE_RELATIONS: Record<string, string[]> = {
  ...
  // === Wearable cluster ===
  'smart-watches':   ['fitness-trackers', 'sleep-trackers', 'smart-rings', 'wireless-earbuds', 'open-ear-headphones', 'over-ear-headphones', 'smart-locks', 'video-doorbells', 'noise-cancelling-headphones'],
  'fitness-trackers': ['smart-watches', 'sleep-trackers', 'smart-rings', 'wireless-earbuds', 'open-ear-headphones', 'over-ear-headphones', 'smartphones', 'bluetooth-speakers'],
  'sleep-trackers':  ['smart-rings', 'fitness-trackers', 'smart-watches', 'wireless-earbuds', 'bluetooth-speakers'],
  'smart-rings':     ['sleep-trackers', 'fitness-trackers', 'smart-watches', 'wireless-earbuds', 'smartphones'],
  'wireless-earbuds': ['smart-watches', 'fitness-trackers', 'sleep-trackers', 'smart-rings', 'open-ear-headphones', 'over-ear-headphones', 'bluetooth-speakers', 'noise-cancelling-headphones', 'smartphones'],
  'open-ear-headphones': ['wireless-earbuds', 'over-ear-headphones', 'fitness-trackers', 'smart-watches', 'bluetooth-speakers'],
  'over-ear-headphones': ['wireless-earbuds', 'open-ear-headphones', 'bluetooth-speakers', 'noise-cancelling-headphones', 'smart-watches', 'smartphones'],
  'bluetooth-speakers': ['over-ear-headphones', 'open-ear-headphones', 'wireless-earbuds', 'smartphones', 'smart-watches', 'fitness-trackers'],
...
export const CATEGORY_CLUSTERS: CategoryCluster[] = [
  ...
  { id: 'wearable-tech-audio', name: 'Wearable & Audio',     slugs: ['smart-watches', 'fitness-trackers', 'sleep-trackers', 'smart-rings', 'wireless-earbuds', 'open-ear-headphones', 'over-ear-headphones', 'bluetooth-speakers'] },
