// Generate new categories JSON for DecisionRank seed
...
const specsByProduct = {
  ...
  // Stream Decks
  "e6f7a8b9-c0d1-2345-6789-0123456789ab": [
  ...
  "f7a8b9c0-d1e2-3456-7890-123456789abc": [
    ...
    { name: "Software", value: "Loupedeck Console (Lightroom, Premiere, OBS)" },
  ...
  "c0d1e2f3-a4b5-6789-0123-456789abcdef": [
    ...
    { name: "Latency", value: "< 100ms on 5 GHz WiFi" },
  ],
  ...
  // Smart Lighting
  "f4a5b6c7-d8e9-2345-6789-0123456789ab": [
    { name: "Brightness", value: "800", unit: "lumens" },
    { name: "Color Range", value: "16M colors + white (2000K–6500K)" },
    { name: "Connectivity", value: "Zigbee (requires Hue Bridge)" },
    { name: "Power", value: "9.5", unit: "W" },
    { name: "Lifespan", value: "25,000", unit: "hours" },
    { name: "Protocol", value: "Zigbee 3.0" },
  ],
  "a5b6c7d8-e9f0-3456-7890-123456789abc": [
    { name: "Panel Type", value: "Modular hexagonal panels" },
  ...
  "b6c7d8e9-f0a1-4567-8901-23456789abcd": [
  ...
  "c7d8e9f0-a1b2-5678-9012-3456789abcde": [
    { name: "Brightness", value: "800", unit: "lumens" },
    { name: "Color Temperature", value: "2700K–6500K tunable white" },
    { name: "Connectivity", value: "Wi-Fi (2.4 GHz)" },
    { name: "Power", value: "7.5", unit: "W" },
    { name: "Lifespan", value: "25,000", unit: "hours" },
    { name: "Hub Required", value: "No (direct)" },
  ],
  "d8e9f0a1-b2c3-6789-0123-456789abcdef": [
    { name: "Brightness", value: "1100", unit: "lumens" },
    { name: "Color Range", value: "16M colors + full white spectrum" },
    { name: "Connectivity", value: "Wi-Fi (2.4/5 GHz) + Bluetooth setup" },
    { name: "Power", value: "11", unit: "W" },
    { name: "Lifespan", value: "40,000", unit: "hours" },
    { name: "Protocol", value: "Wi-Fi (Tuya cloud)" },
  ],
  "e9f0a1b2-c3d4-7890-1234-56789abcdef0": [
    { name: "Brightness", value: "800", unit: "lumens" },
    { name: "Color Temperature", value: "2700K–6500K tunable white" },
    { name: "Connectivity", value: "Wi-Fi (2.4 GHz)" },
...
// Sentiments per product: 6 per product (3 pro, 3 con)
const sentimentsByProduct = {
  // Monitor Arms
  "c3d4e5f6-a7b8-9012-cdef-345678901234": [
...
const faqsByRanking = {
  ...
  "d5e6f7a8-b9c0-1234-5678-90123456789a": [
    { question: "Do I need a Stream Deck if I'm just starting to stream?", answer: "Not necessarily. Begin with keyboard shortcuts and OBS hotkeys. A Stream Deck becomes valuable once your scene switching, source toggling, and macro use exceed what you can comfortably remember. Many streamers add one after their setup stabilizes and they want faster, error-free production control." },
    { question: "What's the difference between Stream Deck and Loupedeck?", answer: "Stream Deck focuses on simple button-triggered actions across streaming, YouTube, and general macro functions. Loupedeck is designed for creative pros (Lightroom, Premiere) with dials for precise adjustments. Choose Stream Deck for OBS-centric streaming; choose Loupedeck if photo/video editing is your primary workflow." },
    { question: "Can I use a Stream Deck on Mac and Windows?", answer: "Yes. Elgato Stream Deck software supports macOS (10.15+) and Windows 10/11. Settings sync via cloud, so you can move between machines. Core functionality is identical across platforms." },
    { question: "Can Stream Deck execute scripts or launch applications?", answer: "Absolutely. You can map keys to launch apps, run shell scripts or batch files, open URLs, insert text snippets, control system volume, or trigger complex multi-step macros." },
    { question: "Is wireless reliability a concern with Stream Deck Mobile?", answer: "On a stable 5 GHz WiFi network, mobile is responsive. However, interference or congestion can cause lag or disconnects. For mission-critical live streaming, a wired USB Stream Deck remains the gold standard." },
  ],
  "e3f4a5b6-c7d8-1234-5678-90123456789a": [
    { question: "Do smart bulbs require a hub or bridge?", answer: "Some do, some don't. Wi-Fi bulbs (Wyze, TP-Link Kasa, LIFX) connect directly to your router without a hub. Zigbee or Bluetooth Mesh bulbs (Philips Hue, IKEA Trådfri) require a bridge/hub that translates Zigbee to Wi-Fi. Hub systems offer reliability and broader device support but add cost and complexity." },
    { question: "Can I use smart bulbs with a regular light switch?", answer: "Yes, but keep the switch turned ON at all times. If you turn off a physical wall switch, the bulb loses power and won't respond to app/voice commands. For homes where switches get flipped, consider smart switches instead of smart bulbs." },
    { question: "What's the difference between 2700K and 6500K?", answer: "Kelvin (K) indicates color temperature: 2700K is warm white (cozy), 6500K is cool/daylight white (energizing). Many smart bulbs offer tunable white, allowing adjustment between these temperatures for different moods and times of day." },
    { question: "Are smart bulbs secure? Can they be hacked?", answer: "Smart bulbs use Wi-Fi, Zigbee, or Bluetooth. Keep firmware updated, use strong passwords, and segment IoT devices if concerned. Reputable brands like Philips Hue and Nanoleaf regularly patch vulnerabilities, though no IoT device is 100% unhackable." },
    { question: "Do smart bulbs work with Amazon Alexa and Google Home?", answer: "Yes, virtually all smart bulbs integrate with Alexa and Google Assistant via cloud or local skills. You can control them by voice, create routines, and group them. Some brands also support Apple HomeKit." },
  ],
};
...
const out = {
  ...
  rankings: [
    ...
    },
    {
      ...
      category_id: "c4d5e6f7-a8b9-0123-4567-890123456789a",
      created_at: now(), updated_at: now()
    },
    {
      ...
      category_id: "d2e3f4a5-b6c7-8901-2345-678901234567",
      created_at: now(), updated_at: now()
    }
  ],
  products: [
    // Monitor Arms
    { id: "c3d4e5f6-a7b8-9012-cdef-345678901234", name: "Fully Jarvis Monitor Arm", link: "https://fully.com/desks-and-accessories/monitor-arms/jarvis-monitor-arm", created_at: now(), updated_at: now() },
    { id: "d4e5f6a7-b8c9-0123-def0-456789012345", name: "Ergotron LX HD", link: "https://www.ergotron.com/en/products/lx-hd", created_at: now(), updated_at: now() },
    { id: "e5f6a7b8-c9d0-1234-ef01-567890123456", name: "Humanscale M2.1", link: "https://www.humanscale.com/products/monitor-arms/m2-1", created_at: now(), updated_at: now() },
    { id: "f6a7b8c9-d0e1-2345-f012-678901234567", name: "VESA Mount ArmWorks", link: "https://www.vesa.org/mount/armworks", created_at: now(), updated_at: now() },
    { id: "a7b8c9d0-e1f2-3456-0123-789012345678", name: "AmazonBasics VESA Mount Arm", link: "https://www.amazon.com/dp/B07X5T4X3R", created_at: now(), updated_at: now() },
    { id: "b8c9d0e1-f2a3-4567-1234-890123456789", name: "3M Ergonomic Monitor Arm", link: "https://www.3m.com/3M/en_US/company-us/all-3m-products/~/All-3M-Products/Office-Products/Ergonomic-Products/Monitor-Mounts/", created_at: now(), updated_at: now() },
    // Stream Decks
    { id: "e6f7a8b9-c0d1-2345-6789-0123456789ab", name: "Elgato Stream Deck Mk.2 (15 keys)", link: "https://www.elgato.com/en/products/stream-deck-xl", created_at: now(), updated_at: now() },
    { id: "f7a8b9c0-d1e2-3456-7890-123456789abc", name: "Loupedeck CT", link: "https://loupedeck.com/products/loupedeck-ct/", created_at: now(), updated_at: now() },
    { id: "a8b9c0d1-e2f3-4567-8901-23456789abcd", name: "Elgato Stream Deck XL (32 keys)", link: "https://www.elgato.com/en/products/stream-deck-xl", created_at: now(), updated_at: now() },
    { id: "b9c0d1e2-f3a4-5678-9012-3456789abcde", name: "Elgato Stream Deck Mini (6 keys)", link: "https://www.elgato.com/en/products/stream-deck", created_at: now(), updated_at: now() },
    { id: "c0d1e2f3-a4b5-6789-0123-456789abcdef", name: "Stream Deck Mobile (iOS/Android)", link: "https://www.elgato.com/en/products/stream-deck-mobile-app", created_at: now(), updated_at: now() },
    { id: "d1e2f3a4-b5c6-7890-1234-56789abcdef0", name: "X-Keys XK-24", link: "https://shop.x-keys.com/products/xk-24", created_at: now(), updated_at: now() },
    // Smart Lighting
    { id: "f4a5b6c7-d8e9-2345-6789-0123456789ab", name: "Philips Hue White and Color Ambiance (A19)", link: "https://www.philips-hue.com/en-us/products/hue-white-and-color-ambiance-a19", created_at: now(), updated_at: now() },
    { id: "a5b6c7d8-e9f0-3456-7890-123456789abc", name: "Nanoleaf Shapes Hexagons", link: "https://nanoleaf.me/en-US/products/nanoleaf-shapes-hexagons/", created_at: now(), updated_at: now() },
    { id: "b6c7d8e9-f0a1-4567-8901-23456789abcd", name: "Govee RGBIC LED Light Strip", link: "https://www.govee.com/products/govee-rgbic-led-strip-lights", created_at: now(), updated_at: now() },
    { id: "c7d8e9f0-a1b2-5678-9012-3456789abcde", name: "Wyze Bulb (White)", link: "https://wyze.com/wyze-bulb-white.html", created_at: now(), updated_at: now() },
    { id: "d8e9f0a1-b2c3-6789-0123-456789abcdef", name: "LIFX Color", link: "https://www.lifx.com/products/lifx-color-bulb", created_at: now(), updated_at: now() },
    { id: "e9f0a1b2-c3d4-7890-1234-56789abcdef0", name: "TP-Link Kasa Smart Bulb (KL130)", link: "https://www.kasasmart.com/us/products/smart-lighting/kasa-smart-bulb-kl130", created_at: now(), updated_at: now() }
  ],
  ranking_products: [
    // Monitor Arms
    { id: "rp-ma-1", ranking_id: "b2c3d4e5-f6a7-8901-bcde-f23456789012", product_id: "c3d4e5f6-a7b8-9012-cdef-345678901234", score: 9.4, rank_position: 1, created_at: now(), updated_at: now() },
    { id: "rp-ma-2", ranking_id: "b2c3d4e5-f6a7-8901-bcde-f23456789012", product_id: "d4e5f6a7-b8c9-0123-def0-456789012345", score: 9.1, rank_position: 2, created_at: now(), updated_at: now() },
    { id: "rp-ma-3", ranking_id: "b2c3d4e5-f6a7-8901-bcde-f23456789012", product_id: "e5f6a7b8-c9d0-1234-ef01-567890123456", score: 8.8, rank_position: 3, created_at: now(), updated_at: now() },
    { id: "rp-ma-4", ranking_id: "b2c3d4e5-f6a7-8901-bcde-f23456789012", product_id: "f6a7b8c9-d0e1-2345-f012-678901234567", score: 8.3, rank_position: 4, created_at: now(), updated_at: now() },
    { id: "rp-ma-5", ranking_id: "b2c3d4e5-f6a7-8901-bcde-f23456789012", product_id: "a7b8c9d0-e1f2-3456-0123-789012345678", score: 7.9, rank_position: 5, created_at: now(), updated_at: now() },
    { id: "rp-ma-6", ranking_id: "b2c3d4e5-f6a7-8901-bcde-f23456789012", product_id: "b8c9d0e1-f2a3-4567-1234-890123456789", score: 7.5, rank_position: 6, created_at: now(), updated_at: now() },
    // Stream Decks
    { id: "rp-sd-1", ranking_id: "d5e6f7a8-b9c0-1234-5678-90123456789a", product_id: "e6f7a8b9-c0d1-2345-6789-0123456789ab", score: 9.3, rank_position: 1, created_at: now(), updated_at: now() },
    { id: "rp-sd-2", ranking_id: "d5e6f7a8-b9c0-1234-5678-90123456789a", product_id: "f7a8b9c0-d1e2-3456-7890-123456789abc", score: 9.0, rank_position: 2, created_at: now(), updated_at: now() },
    { id: "rp-sd-3", ranking_id: "d5e6f7a8-b9c0-1234-5678-90123456789a", product_id: "a8b9c0d1-e2f3-4567-8901-23456789abcd", score: 8.8, rank_position: 3, created_at: now(), updated_at: now() },
    { id: "rp-sd-4", ranking_id: "d5e6f7a8-b9c0-1234-5678-90123456789a", product_id: "b9c0d1e2-f3a4-5678-9012-3456789abcde", score: 8.2, rank_position: 4, created_at: now(), updated_at: now() },
    { id: "rp-sd-5", ranking_id: "d5e6f7a8-b9c0-1234-5678-90123456789a", product_id: "c0d1e2f3-a4b5-6789-0123-456789abcdef", score: 7.9, rank_position: 5, created_at: now(), updated_at: now() },
    { id: "rp-sd-6", ranking_id: "d5e6f7a8-b9c0-1234-5678-90123456789a", product_id: "d1e2f3a4-b5c6-7890-1234-56789abcdef0", score: 7.6, rank_position: 6, created_at: now(), updated_at: now() },
    // Smart Lighting
    { id: "rp-sl-1", ranking_id: "e3f4a5b6-c7d8-1234-5678-90123456789a", product_id: "f4a5b6c7-d8e9-2345-6789-0123456789ab", score: 9.5, rank_position: 1, created_at: now(), updated_at: now() },
    { id: "rp-sl-2", ranking_id: "e3f4a5b6-c7d8-1234-5678-90123456789a", product_id: "a5b6c7d8-e9f0-3456-7890-123456789abc", score: 9.2, rank_position: 2, created_at: now(), updated_at: now() },
    { id: "rp-sl-3", ranking_id: "e3f4a5b6-c7d8-1234-5678-90123456789a", product_id: "b6c7d8e9-f0a1-4567-8901-23456789abcd", score: 8.8, rank_position: 3, created_at: now(), updated_at: now() },
    { id: "rp-sl-4", ranking_id: "e3f4a5b6-c7d8-1234-5678-90123456789a", product_id: "c7d8e9f0-a1b2-5678-9012-3456789abcde", score: 8.4, rank_position: 4, created_at: now(), updated_at: now() },
    { id: "rp-sl-5", ranking_id: "e3f4a5b6-c7d8-1234-5678-90123456789a", product_id: "d8e9f0a1-b2c3-6789-0123-456789abcdef", score: 8.1, rank_position: 5, created_at: now(), updated_at: now() },
    { id: "rp-sl-6", ranking_id: "e3f4a5b6-c7d8-1234-5678-90123456789a", product_id: "e9f0a1b2-c3d4-7890-1234-56789abcdef0", score: 7.9, rank_position: 6, created_at: now(), updated_at: now() }
  ],
  specifications: (() => {
    const arr = [];
    for (const [productId, specs] of Object.entries(specsByProduct)) {
      specs.forEach((s, idx) => {
        arr.push({
          id: `spec-${productId}-${idx}`,
  ...
  sentiments: (() => {
    const arr = [];
    // ranking_product_id map
    const rpMap = {
      "c3d4e5f6-a7b8-9012-cdef-345678901234": "rp-ma-1",
      "d4e5f6a7-b8c9-0123-def0-456789012345": "rp-ma-2",
      "e5f6a7b8-c9d0-1234-ef01-567890123456": "rp-ma-3",
      "f6a7b8c9-d0e1-2345-f012-678901234567": "rp-ma-4",
      "a7b8c9d0-e1f2-3456-0123-789012345678": "rp-ma-5",
      "b8c9d0e1-f2a3-4567-1234-890123456789": "rp-ma-6",
      "e6f7a8b9-c0d1-2345-6789-0123456789ab": "rp-sd-1",
      "f7a8b9c0-d1e2-3456-7890-123456789abc": "rp-sd-2",
      "a8b9c0d1-e2f3-4567-8901-23456789abcd": "rp-sd-3",
      "b9c0d1e2-f3a4-5678-9012-3456789abcde": "rp-sd-4",
      "c0d1e2f3-a4b5-6789-0123-456789abcdef": "rp-sd-5",
      "d1e2f3a4-b5c6-7890-1234-56789abcdef0": "rp-sd-6",
      "f4a5b6c7-d8e9-2345-6789-0123456789ab": "rp-sl-1",
      "a5b6c7d8-e9f0-3456-7890-123456789abc": "rp-sl-2",
      "b6c7d8e9-f0a1-4567-8901-23456789abcd": "rp-sl-3",
      "c7d8e9f0-a1b2-5678-9012-3456789abcde": "rp-sl-4",
      "d8e9f0a1-b2c3-6789-0123-456789abcdef": "rp-sl-5",
      "e9f0a1b2-c3d4-7890-1234-56789abcdef0": "rp-sl-6"
    };
    for (const [productId, rpId] of Object.entries(rpMap)) {
      const sentiments = sentimentsByProduct[productId];
      if (!sentiments) { console.error(`Missing sentiments for ${productId}`); continue; }
      sentiments.forEach((s, idx) => {
        arr.push({
          id: `sent-${productId}-${idx}`,
          ranking_product_id: rpId,
          user_id: null,
          type: s.type,
          content: s.content,
          headline: s.headline,
  ...
  faqs: (() => {
    ...
    rankingOrder.forEach((rankingId, rankIdx) => {
      const faqs = faqsByRanking[rankingId];
      if (!faqs) return;
      faqs.forEach((f, idx) => {
        arr.push({
          id: `faq-${rankingId}-${idx}`,
