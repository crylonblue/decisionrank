-- Add users (using images from public/users folder)
INSERT INTO users (id, name, profile_picture_url) VALUES
  ('990e8400-e29b-41d4-a716-446655440001', 'CoffeeOverflow', '/users/CoffeeOverflow.png'),
  ('990e8400-e29b-41d4-a716-446655440002', 'LaggingIRL', '/users/LaggingIRL.png'),
  ('990e8400-e29b-41d4-a716-446655440003', 'NotAIButClose', '/users/NotAIButClose.jpeg'),
  ('990e8400-e29b-41d4-a716-446655440004', 'ProbablyAFK', '/users/ProbablyAFK.png'),
  ('990e8400-e29b-41d4-a716-446655440005', 'RedditBot', '/users/RedditBot.png');
...
-- Update sentiments with user_id (distributing all 5 users)
-- Osprey Farpoint 40 - Pros
UPDATE sentiments SET user_id = '990e8400-e29b-41d4-a716-446655440001' -- CoffeeOverflow
...
UPDATE sentiments SET user_id = '990e8400-e29b-41d4-a716-446655440002' -- LaggingIRL
WHERE ranking_product_id = '770e8400-e29b-41d4-a716-446655440001' 
  AND type = 'pro' 
  AND content = 'Perfect size for carry-on compliance';

UPDATE sentiments SET user_id = '990e8400-e29b-41d4-a716-446655440003' -- NotAIButClose
WHERE ranking_product_id = '770e8400-e29b-41d4-a716-446655440001' 
  AND type = 'pro' 
  AND content = 'Great organization with multiple compartments';

UPDATE sentiments SET user_id = '990e8400-e29b-41d4-a716-446655440004' -- ProbablyAFK
WHERE ranking_product_id = '770e8400-e29b-41d4-a716-446655440001' 
  AND type = 'pro' 
  AND content = 'Durable construction with lifetime warranty';

-- Osprey Farpoint 40 - Cons
UPDATE sentiments SET user_id = '990e8400-e29b-41d4-a716-446655440005' -- RedditBot
WHERE ranking_product_id = '770e8400-e29b-41d4-a716-446655440001' 
  AND type = 'con' 
